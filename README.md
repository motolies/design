...
### [📦 부록: 실무 패턴 (Appendix)](./appendix)
GoF 패턴 외에 실무에서 자주 사용되는 추가 패턴들을 다룹니다.

**주요 패턴**: Circuit Breaker, Retry, Repository, CQRS, Saga, Null Object 외 7개
...
5단계: 실무 심화 패턴 (부록)
└── Repository → Circuit Breaker → Retry → CQRS → Saga
```
